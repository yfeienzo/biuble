    ...
    return (
        <FadeIn>
            <div className="row">
                ...
                day.type === "pics" ? JSON.parse(day.content).map(address => address.split(".")[address.split(".").length-1] === 'mov'  ? <video controls width={240} preload="metadata"><source src={address} type="video/mp4"/></video> : <img width="100%" src={address} /> ):
                day.type == "poems" ? 
                <div>{poem}</div>
